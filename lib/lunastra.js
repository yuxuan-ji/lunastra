...
function () {
  ...
  _createClass(Pipeline, [{
    ...
    key: "insertAfter",
    value: function insertAfter(existingFct, newFct) {
    ...
    key: "insertBefore",
    value: function insertBefore(existingFct, newFct) {
      var pos = this._queue.indexOf(existingFct);
